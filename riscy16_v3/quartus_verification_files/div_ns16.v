...
// =============================================================================
// Signal guide:
//   clk,reset      : sequential control for divider state.
//   start          : begins one divide when divider is idle.
//   dividend       : unsigned numerator, latched into quotient work register.
//   divisor        : unsigned denominator, latched before iteration.
//   quotient       : final quotient output.
//   remainder      : final remainder output.
//   busy           : high during the 16 iterative divide cycles.
//   done           : one-cycle pulse when outputs are valid.
//   divide_by_zero : high after a divide-by-zero request.
