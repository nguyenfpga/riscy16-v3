// =============================================================================
// processor.v -- RISCY-16 v3 five-stage pipeline shell
//   Stage 1 preserves the v1 regression ISA while replacing the bus FSM with
...
module processor(clk,reset,start,test_pc_address);
	input clk, reset, start;
	output test_pc_address;
	...
	assign test_pc_address = pc_address ;
