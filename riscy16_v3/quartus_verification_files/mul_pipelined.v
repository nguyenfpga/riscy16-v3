...
// =============================================================================
// Signal guide:
//   A,B     : 16-bit unsigned multiply operands.
//   product : 32-bit product; low half writes Rx, high half writes Rx+1.
//   pp*     : shifted partial products selected by bits of B.
//   l1_*    : first adder-tree reduction layer.
//   l2_*    : second adder-tree reduction layer.
//   l3_*    : third adder-tree reduction layer before final add.
