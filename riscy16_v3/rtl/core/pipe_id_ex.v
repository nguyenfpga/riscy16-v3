// =============================================================================
// pipe_id_ex.v -- decode to execute pipeline register
// =============================================================================
module pipe_id_ex(clk,reset,flush,stall,valid_in,instr_in,src_a_in,src_b_in,imm_in,rx_in,ry_in,reg_write_in,mem_read_in,mem_write_in,branch_in,jump_in,alu_operation_in,A_invert_in,B_negate_in,simd_mode_in,result_sel_in,dual_write_in,valid_out,instr_out,src_a_out,src_b_out,imm_out,rx_out,ry_out,reg_write_out,mem_read_out,mem_write_out,branch_out,jump_out,alu_operation_out,A_invert_out,B_negate_out,simd_mode_out,result_sel_out,dual_write_out);
