...
// =============================================================================
// Signal guide:
//   A,B       : two packed 8-bit multiply operands per 16-bit word.
//   Al,Bl     : low byte lane operands.
//   Ah,Bh     : high byte lane operands.
//   prod_low  : 16-bit low-lane product.
//   prod_high : 16-bit high-lane product.
//   product   : {prod_high, prod_low}, written through dual-write path.
