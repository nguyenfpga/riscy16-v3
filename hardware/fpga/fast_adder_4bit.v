// =============================================================================
// fast_adder_4bit.v -- 4-bit carry-lookahead adder leaf
// =============================================================================
// Signal guide:
//   a,b          : 4-bit add operands.
//   cin          : carry input into bit 0.
//   out          : 4-bit sum output.
//   cout         : carry output from bit 3.
//   Ggroup,Pgroup: group generate/propagate for higher-level CLA logic.
