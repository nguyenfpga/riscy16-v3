...
// =============================================================================
// Signal guide:
//   clk,reset       : sequential register control.
//   data_in/write_* : primary writeback value, address, and enable.
//   data_in2/write2 : secondary writeback path for Rx+1 results.
//   Ra_addr,Rb_addr : two read-port register addresses.
//   Ra_out,Rb_out   : two read-port values.
//   *_sel           : one-hot decoded read/write selects.
//   reg_out         : stored values for R0-R31.
